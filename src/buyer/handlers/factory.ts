...
import type { BuyerIntegration, BuyerUserConfig } from "../types";

export class TradeHandlerFactory<
  T1 extends DefaultParams,
  T2 extends AdCOMContext
> {
  public constructor(private integration: BuyerIntegration<T1>) {}

  public createOpenRTB(userConfig: BuyerUserConfig<T1>, context: T2) {
