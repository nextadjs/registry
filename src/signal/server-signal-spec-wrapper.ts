...
export class ServerSignalSpecWrapper<
  TParams extends DefaultParams = DefaultParams,
  TData = unknown,
  TContext extends AdCOMContext = AdCOMContext
> implements SignalSpecWrapper<ServerAsyncCollect, TData>
{
  public constructor(
    private readonly _userConfig: SignalUserConfig<TParams>,
    private readonly _spec: ServerSignalSpec<TParams, TData, TContext>,
